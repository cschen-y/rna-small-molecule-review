...
def train_supervised(model,
                     optimizer,
                     train_loader,
                     learning_routine=LearningRoutine(save_path='model_pth/')):
    """
        ...
        if learning_routine.validation_loader is None:
            ...
            if validation_losstest3 > 0.783 and validation_losstest18 > 0.776:
                torch.save({
                    ...
                    'model_state_dict': model.state_dict(),
                    'optimizer_state_dict': optimizer.state_dict()
                }, f'./Same7_1024_42_10_{epoch}_{validation_losstest3}_{validation_losstest18}.pth')
        if early_stop:
            pass
